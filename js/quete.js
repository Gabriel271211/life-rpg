...
// et ouverture de l'éditeur de quête principale.
// ============================================
...
(function () {
  ...
  function rendre() {
    // Une étape dont l'objectif a été réduit sous le progrès se
    // complète ici, au rendu — le progrès n'est jamais volé.
    if (Regles.rattraperQuetePrincipale(etat).length > 0) {
